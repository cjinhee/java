...
public class Ex15_Operator {
	...
	public static void main(String[] args) {
		...
		/*
				...
				- 피연산자를 대상으로 미리 정해진 행동(연산)을 한 후에 행동(연산)의 결과를 반환하는 요쇼
		...
		*/
		...
		System.out.printf("%d / %d = %d\n", a, b, a/b); //10 / 3 = 3(몫)
		System.out.printf("%d %% %d = %d\n", a, b, a%b); //10 % 3 = 1(나머지)
		// 에러 java.util.IllegalFormatFlagsException: Flags = ' ' -> %% 두개 사용하기
		System.out.println();
	    ...
	    //System.out.println(100 / 0); 오류가 남 
		...
		System.out.println(e + f); // 30억 -> -1,294,967,296 int니까 오버플로우가 발생. int보다 더 큰 long으로 만들어야함
		...
		System.out.println(e * (long)f); //오버플로우 수정을 위해서 둘 중에 하나를 변환해야함
		...
		//*** 위와 같은 이유 > 정수사용 > byte, short를 거의 사용 안함
		//    정수 > 주로 int 사용
