...
public class Ex05_Variable {
	...
	public static void main(String[] args) {
		...
		f1 =123.123456789012345678901234567890123456789012345678901234567890F;
		d1 =123.123456789012345678901234567890123456789012345678901234567890D;
		...
		//문자형
		char c1;
		c1 = 'A'; //A cannot be resolved to a variable > 문자 리터럴 / 홑따옴표 써야함
		...
		// c1 = '홍길동' - 한글자만 넣어야함 '홍' 한글자만 표현할수 있음
		...
		// 글자를 여러개를 한번에 저장할 수 있는 자료형
		
		String name; 
		
		name = "홍길동"; // 문자열 상수(리터럴) 표기법 문자와 문자사이에 엔터 치면 안됨
